...
{
	?>
	<FORM action="additional_points_update.php" method="POST">
		<table class="table_default">
			<thead>
				<tr class="tr_head">
					<th>No</th><th>ФИО</th><th>Дополнительный Балл</th><th></th><th></th>
				</tr>
			</thead>
			<tbody>
			...
			{ 
				...
				<TR style="text-align:center; background-color:<?php echo $bgcolor; ?>">
					...
					<TD><INPUT type="text" size="3" name="<?php echo $id_user;?>" value="<?php echo iden_additional_ball ($id_user, $id_course, $year, $semestr)?>"></INPUT></TD>
					<TD></TD><TD></TD>
				</TR>
				<?php
			}
		...
		<INPUT type="submit" value="Внести Дополнительные Баллы">
	</FORM>
  <?php
} else {
